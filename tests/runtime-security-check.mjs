...
const invalidBase = { customerName: "Cliente Teste", whatsapp: "28999998888", instagram: "cliente.teste", consent: true, website: "" };
...
console.log(JSON.stringify({
  checked: "storefront, auth, CSRF, XSS input, size limits, stock aggregation, price integrity, IDOR, admin mutations, rate limits, concurrency",
  concurrentOrders: 25,
